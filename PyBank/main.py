...
#find max value in the set - stay in for loop so it goes through all    
        date = row[0]
        #
        ...
        if change_in_profit > max_value:
            ...
            max_date = date
#find min value in the set- stay in for loop so it goes through all rows
        date = row[0]
...
#finding the average. -1 to compare to the previious month to find change from previous month.
